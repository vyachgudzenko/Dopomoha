...
extension MyHelpController:UICollectionViewDataSource{
...
extension MyHelpController:UICollectionViewDelegate{
    
}

extension MyHelpController:UICollectionViewDelegateFlowLayout{
